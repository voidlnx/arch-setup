...
sudo pacman -Syu --noconfirm lib32-mesa gdm gnome hyprland htop curl wget blueman pipewire alsa-utils pipewire-alsa pipewire-pulse
pipewire-jack wireplumber pavucontrol noto-fonts noto-fonts-emoji ttf-font-awesome ttf-liberation ttf-dejavu rofi-emoji libxcb
